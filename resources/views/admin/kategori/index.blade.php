...
@section('content')
    ...
    {{-- Search Bar --}}
    <form method="GET" action="{{ route('admin.kategori.index') }}" class="mb-5 flex gap-3">
        {{-- Search --}}
    ...
    @push('scripts')
        <script>
            function openModalEdit(id, ketKategori) {
                ...
                // char counter
                const input = document.getElementById('editKetKategori');
            ...
            document.addEventListener('DOMContentLoaded', function() {
                const input = document.getElementById('ketKategori');
                ...
                const editInput = document.getElementById('editKetKategori');
