...
<head>
    ...
    <meta name="description"
        content="AspirasiKu adalah platform aspirasi siswa untuk menyampaikan suara, ide, dan harapan demi masa depan pendidikan yang lebih baik.">
    ...
    <meta property="og:description"
        content="Platform aspirasi siswa untuk menyampaikan suara, ide, dan harapan demi masa depan pendidikan yang lebih baik.">
...
<body x-data="{ mobileOpen: false }" class="bg-slate-50 text-slate-900 antialiased overflow-x-hidden">
                ...
                <div class="relative rounded-2xl border border-slate-200/80 bg-white shadow-2xl overflow-hidden">
                    ...
                    <div class="p-4 bg-white text-left space-y-4">
                        ...
                        <div class="rounded-xl border border-slate-100 overflow-hidden">
                            ...
                            <!-- Header -->
                            <div
                                class="flex items-center justify-between px-3 sm:px-4 py-2.5 bg-slate-50 border-b border-slate-100">
                                ...
                                <span class="text-[11px] font-semibold text-indigo-500 whitespace-nowrap">Lihat semua
                                    →</span>
                            </div>

                            <!-- Row: Perbaikan Toilet -->
                            <div class="flex items-center gap-3 px-3 sm:px-4 py-3 border-b border-slate-50">
                                <div
                                    class="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-br from-violet-100 to-indigo-100 flex items-center justify-center flex-shrink-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs font-semibold text-slate-700 truncate">Perbaikan Toilet Lantai 2
                                    </p>
                                    <div class="flex flex-wrap gap-x-0 items-center">
                                ...
                                <div class="flex flex-col items-end gap-1 flex-shrink-0">
                                    <span
                                        class="inline-flex items-center gap-1 text-[10px] font-semibold px-2 py-0.5 rounded-lg bg-amber-50 text-amber-700 ring-1 ring-amber-200 whitespace-nowrap">
                            ...
                            <!-- Row: Penambahan Buku -->
                            <div class="flex items-start gap-3 px-3 sm:px-4 py-3 border-b border-slate-50">
                                <div
                                    class="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-br from-violet-100 to-indigo-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                                    <svg class="w-4 h-4 text-violet-500" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                                            d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs font-semibold text-slate-700 truncate">Penambahan Buku
                                        Perpustakaan</p>
                                    <div class="flex flex-wrap items-center">
                                        <p class="text-[10px] text-slate-400 mt-0.5">Akademik &nbsp;·&nbsp;</p>
                                        <p class="text-[10px] text-slate-400 mt-0.5 flex gap-1 items-center">
                                            <svg class="w-3 h-3 flex-shrink-0" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <p class="text-[10px] text-slate-400 mt-0.5">20 Mar 2025</p>
                                    </div>
                                    <p class="mt-1.5 text-[10px] w-fit">
                                        🙍‍♂️💬: <span
                                            class="text-slate-500 bg-slate-100 font-mono rounded-r-full rounded-tl-full px-2.5 py-1">
                                            Buku sudah ditambah.</span>
                                    </p>
                                </div>
                                <div class="flex flex-col items-end gap-1 flex-shrink-0">
                                    <span
                                        class="inline-flex items-center gap-1 text-[10px] font-semibold px-2 py-0.5 rounded-lg bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200 whitespace-nowrap">
                            ...
                            <div class="flex items-center gap-3 px-3 sm:px-4 py-3 border-b border-slate-50">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs font-semibold text-slate-700 truncate">WiFi di Ruang Kelas</p>
                                    <div class="flex flex-wrap items-center">
                                        <p class="text-[10px] text-slate-400 mt-0.5">Teknologi &nbsp;·&nbsp;</p>
                                        <p class="text-[10px] text-slate-400 mt-0.5 flex gap-1 items-center">
                                            <svg class="w-3 h-3 flex-shrink-0" fill="none" viewBox="0 0 24 24"
                                                stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <p class="text-[10px] text-slate-400 mt-0.5">15 Mar 2025</p>
                                    </div>
                                </div>
                                <div class="flex flex-col items-end gap-1 flex-shrink-0">
                                    <span
                                        class="inline-flex items-center gap-1 text-[10px] font-semibold px-2 py-0.5 rounded-lg bg-sky-50 text-sky-700 ring-1 ring-sky-200 whitespace-nowrap">
                            ...
                            <!-- Row: Kantin -->
                            <div class="flex items-start gap-3 px-3 sm:px-4 py-3">
                                <div
                                    class="w-8 h-8 sm:w-9 sm:h-9 rounded-xl bg-gradient-to-br from-violet-100 to-indigo-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                                    <svg class="w-4 h-4 text-violet-500" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor" stroke-width="2">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="text-xs font-semibold text-slate-700 truncate">Kantin Lebih Sehat</p>
                                    <div class="flex flex-wrap items-center">
