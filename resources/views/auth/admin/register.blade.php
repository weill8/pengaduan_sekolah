...
<head>
    ...
    <title>Register Admin — AspirasiKu</title>
    ...
    <div class="relative w-full max-w-md fade-in" style="animation-delay: 0.1s">
        ...
        <div class="relative rounded-2xl border border-slate-200/80 bg-white shadow-2xl overflow-hidden">
            ...
            <div class="px-8 pt-8 pb-6 text-center">
                ...
                <h1 class="font-display font-800 text-2xl text-slate-900 mb-2">Register Admin</h1>
                <p class="text-sm text-slate-500">Buat akun admin baru untuk mengelola aspirasi</p>
            </div>

            {{-- Form --}}
            <form method="POST" action="{{ route('admin.register') }}" class="px-8 pb-8">
                @csrf
